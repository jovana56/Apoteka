...
<head>
	...
	<link rel="stylesheet" type="text/css" href="jquery-ui-themes-1.12.1/themes/overcast/jquery-ui.css" />
	<style type="text/css" src="//cdn.datatables.net/1.10.20/css/jquery.dataTables.min.css"></style>
		...
		$(document).ready(function() {
			var table = $('#example').dataTable({
				...
				"columns": [{
					...
					{
						"title": "Naziv proizvođača"
					},
					{
						"title": "Adresa proizvođača"
					},
					{
						"title": "Naziv dobavljača"
					},
					{
						"title": "Adresa dobavljača"
					}
...
<body>
	...
	<br>
	<button id="btnDeleteRow">Obriši lek</button>
</body>
