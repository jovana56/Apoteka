$(document).ready(function() {
	...
	$("body").delegate(".proizvodjac","click",function(event){
		...
		// alert(aid);
			...
			url : "action.php",
			method : "POST",
			data : {get_selected_proizvodjac:1,proizvodjac_id:aid},
			success: function(data){
				$("#get_proizvod").html(data);
			}
		})
	...
	$("body").delegate(".selectdobavljac","click",function(event){
		event.preventDefault();
		...
		// alert(cid);
			...
			url : "action.php",
			method : "POST",
			data : {selectdobavljac:1,dobavljac_id:iid},
			success: function(data){
				$("#get_proizvod").html(data);
			}
		})
	...
	$("body").delegate("#lek","click",function(event){
		event.preventDefault();
		...
		$.ajax({
			url : "action.php",
			method : "POST",
			data : {dodavanjelekovi:1,lekId:k_id},
			success : function(data){
				// alert(data);
	...
	$("#prikazSviLekovi_btn").click(function(){
		$.ajax({
			url : "action.php",
			method : "POST",
			data : {getProizvod:1},
