...
if(empty($f_name) || empty($l_name) || empty($email) || empty($password) || empty($repassword) ||
	...
	if(!preg_match($number,$mobile)){
		...
		?>
			<div class='alert alert-warning'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>Uneti broj mobilnog telefona <?php echo "$mobile"; ?> nije validan!</b>
			</div>
		<?php
		exit();
	...
	if(!(strlen($mobile) == 10)){
		...
		?>
			<div class='alert alert-warning'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>Broj mobilnog telefona mora imati 10 cifara!</b>
			</div>
		<?php
		exit();
	...
	if($count_email > 0){
		...
		?>
			<div class='alert alert-danger'>
				<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
				<b>Ova email adresa već postoji u bazi! Molimo, pokušajte sa drugom email adresom.</b>
			</div>
		<?php
		exit();
